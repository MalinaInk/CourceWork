...
//static, т.к. метод main - static
    public static void main(String[] args) {
        //в методе - заполняем
        employees[0] = new Employee("Тиунов Георгий", 1,35_000);
        employees[1] = new Employee("Сафуанов Артем", 2,28_000);
        employees[2] = new Employee("Булдаков Илья", 3,42_000);
        employees[3] = new Employee("Горяева Дарья", 4, 58_000);
        employees[4] = new Employee("Денисенко Светлана", 5,52_000);
        employees[5] = new Employee("Гимберг Александр", 1,32_000);
        employees[6] = new Employee("Лавринов Вячеслав", 2,34_000);
        employees[7] = new Employee("Морева Дарья", 3,46_000);
        employees[8] = new Employee("Осипов Андрей", 4,39_000);
        employees[9] = new Employee("Ганич Евгения", 5,51_000);
    ...
    private static int getCountEmployees() {
    ...
    private static double getAverageSalary() {
        double averageSalary = (double) calculateSumSalary() / getCountEmployees();
